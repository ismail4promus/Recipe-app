            ...
            <div className="relative h-[25vh] md:h-[40vh] w-full overflow-hidden bg-app-card border-b border-app-border shadow-soft">
                ...
                <div className="absolute top-4 left-6 right-6 flex justify-between items-start z-20">
                    ...
                    <div className="flex items-center gap-2 p-1 bg-app-card border border-app-border rounded-full shadow-soft">
                        <div className="flex items-center bg-app-elevated rounded-md px-2 h-9 border border-app-border">
                        ...
                        <button
                            ...
                            className="h-9 px-4 bg-app-primary text-primary-foreground rounded-md font-semibold text-sm shadow-soft hover:brightness-105 active:scale-95 transition-all flex items-center gap-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-app-primary/60"
                        >
            ...
            <div className="max-w-7xl mx-auto px-4 md:px-8 -mt-6 relative z-10">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-5">
                    {[
                        ...
                        <div key={stat.label} className="bg-app-card border border-app-border p-3 rounded-lg flex flex-col items-center justify-center transition-all shadow-soft relative overflow-hidden group hover:border-app-primary/30">
                ...
                {/* TABS — thin underline indicator */}
                <div className="flex border-b border-app-border mb-4 overflow-x-auto scrollbar-hide">
                    {[
                        ...
                        <button
                            ...
                            className={cn(
                                "relative flex items-center justify-center gap-2 whitespace-nowrap px-4 py-2.5 text-sm font-semibold transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-app-primary/60",
                                activeTab === tab.id ? "text-app-primary" : "text-app-muted hover:text-app-text"
                            )}
                        >
                            <tab.icon className="h-4 w-4" /> {tab.label}
                            {activeTab === tab.id && (
                                <motion.div layoutId="tab-indicator" className="absolute -bottom-px left-0 right-0 h-[2px] rounded-sm bg-app-primary" />
                            )}
                        </button>
                    ))}
                </div>
                ...
                {/* SECTION VIEWER */}
                <div className="min-h-[280px] bg-app-card border border-app-border rounded-lg p-3 md:p-4 relative overflow-hidden shadow-soft">
