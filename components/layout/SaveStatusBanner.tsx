    ...
    return (
      <div className="sticky top-14 z-30 border-b border-app-warning/30 bg-app-warning/10 px-3 py-2 md:px-4" role="status">
        <div className="mx-auto flex max-w-[1600px] min-w-0 items-center gap-3">
          ...
          <p className="min-w-0 flex-1 text-sm font-medium leading-relaxed text-app-text">
          ...
          <Link
            to="/signin"
            className="inline-flex h-8 shrink-0 items-center gap-1.5 rounded-full bg-app-primary px-3.5 text-xs font-semibold text-primary-foreground transition-all hover:brightness-105"
          >
    ...
    <AnimatePresence>
      {show && (
        <motion.div
          ...
          role="status"
        >
          <div className="mx-auto flex max-w-[1600px] min-w-0 items-start gap-3">
